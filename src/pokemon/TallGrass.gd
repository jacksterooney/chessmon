...
const grass_overlay_texture = preload("res://pokemon/Assets/Grass/stepped_tall_grass.png")
const GrassStepEffect = preload("res://pokemon/GrassStepEffect.tscn")
...
func player_in_grass():
	if player_inside == true:
		var grass_step_effect = GrassStepEffect.new()
